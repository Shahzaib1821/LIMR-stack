    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                <header className="grid grid-cols-2 items-center shadow-md gap-2 py-4 lg:grid-cols-3 sticky left-0 top-0 z-40 bg-white">
                    <div className="flex lg:justify-start ms-4 lg:col-start-1">
                        <svg
                    ...
                    <nav className="lg:col-start-3 flex flex-1 justify-center">
                        {auth.user ? (
                            <Link
            ...
            <footer className="py-6 relative top-100 bottom-0 left-0 text-center text-sm text-white bg-black  dark:text-white/70">
